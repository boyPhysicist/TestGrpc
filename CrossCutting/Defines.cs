...
namespace CrossCutting
{
    public static class Defines
    {
        ...
        public const string ServerListeningMessage = "Server listening on port ";
        public const string PressAnyKeyServerMessage = "Press any key to stop the server...";
        public const string PcName = "localhost";
        public const string InputMessage = "Enter number from 1 to 5:";
        public const string ResultString = "Result: ";
        public const string PressAnyKeyСlientMessage = "Press any key to exit...";
        public const string WrongValueErrorMessage = "Value must be positive. Please, enter correct value.";
